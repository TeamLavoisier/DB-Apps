...
use ANSR\Propel\Entity\Vendor;
use ANSR\Propel\Entity\VendorQuery;
...
class VendorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ANSR.Propel.Entity.Map.VendorTableMap';
     ...
     */
    const OM_CLASS = '\\ANSR\\Propel\\Entity\\Vendor';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ANSR.Propel.Entity.Vendor';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(VendorTableMap::COL_ID, VendorTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(VendorTableMap::COL_ID => 0, VendorTableMap::COL_NAME => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ANSR\\Propel\\Entity\\Vendor');
    ...
    {
        $this->addRelation('Expence', '\\ANSR\\Propel\\Entity\\Expence', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':vendor_id',
    1 => ':id',
  ),
), null, null, 'Expences', false);
  ...
  array (
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ANSR\Propel\Entity\Vendor) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(VendorTableMap::DATABASE_NAME);
            $criteria->add(VendorTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(VendorTableMap::COL_ID) && $criteria->keyContainsValue(VendorTableMap::COL_ID) ) {
