 ...
 * @method     ChildProductQuery orderByTax($order = Criteria::ASC) Order by the tax column
 * @method     ChildProductQuery orderByVendorId($order = Criteria::ASC) Order by the vendor_id column
 * @method     ChildProductQuery orderByMeasureId($order = Criteria::ASC) Order by the measure_id column
 *
 * @method     ChildProductQuery groupById() Group by the id column
 * @method     ChildProductQuery groupByName() Group by the name column
 * @method     ChildProductQuery groupByTax() Group by the tax column
 * @method     ChildProductQuery groupByVendorId() Group by the vendor_id column
 * @method     ChildProductQuery groupByMeasureId() Group by the measure_id column
 *
 ...
 *
 * @method     ChildProductQuery leftJoinVendor($relationAlias = null) Adds a LEFT JOIN clause to the query using the Vendor relation
 * @method     ChildProductQuery rightJoinVendor($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Vendor relation
 * @method     ChildProductQuery innerJoinVendor($relationAlias = null) Adds a INNER JOIN clause to the query using the Vendor relation
 *
 * @method     ChildProductQuery leftJoinMeasure($relationAlias = null) Adds a LEFT JOIN clause to the query using the Measure relation
 * @method     ChildProductQuery rightJoinMeasure($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Measure relation
 * @method     ChildProductQuery innerJoinMeasure($relationAlias = null) Adds a INNER JOIN clause to the query using the Measure relation
 *
 ...
 *
 * @method     \ANSR\Propel\Entity\VendorQuery|\ANSR\Propel\Entity\MeasureQuery|\ANSR\Propel\Entity\SaleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildProduct findOneByTax(int $tax) Return the first ChildProduct filtered by the tax column
 * @method     ChildProduct findOneByVendorId(int $vendor_id) Return the first ChildProduct filtered by the vendor_id column
 * @method     ChildProduct findOneByMeasureId(int $measure_id) Return the first ChildProduct filtered by the measure_id column *
 ...
 * @method     ChildProduct requireOneByTax(int $tax) Return the first ChildProduct filtered by the tax column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProduct requireOneByVendorId(int $vendor_id) Return the first ChildProduct filtered by the vendor_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProduct requireOneByMeasureId(int $measure_id) Return the first ChildProduct filtered by the measure_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildProduct[]|ObjectCollection findByTax(int $tax) Return ChildProduct objects filtered by the tax column
 * @method     ChildProduct[]|ObjectCollection findByVendorId(int $vendor_id) Return ChildProduct objects filtered by the vendor_id column
 * @method     ChildProduct[]|ObjectCollection findByMeasureId(int $measure_id) Return ChildProduct objects filtered by the measure_id column
...
abstract class ProductQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ANSR\Propel\Entity\Base\ProductQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'supermarkets_chainmssql', $modelName = '\\ANSR\\Propel\\Entity\\Product', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, tax, vendor_id, measure_id FROM products WHERE id = :p0';
        try {
    ...
    public function filterByTax($tax = null, $comparison = null)
    {
        if (is_array($tax)) {
            $useMinMax = false;
            if (isset($tax['min'])) {
                $this->addUsingAlias(ProductTableMap::COL_TAX, $tax['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($tax['max'])) {
                $this->addUsingAlias(ProductTableMap::COL_TAX, $tax['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProductTableMap::COL_TAX, $tax, $comparison);
    }
    ...
    public function filterByVendorId($vendorId = null, $comparison = null)
    {
        if (is_array($vendorId)) {
            ...
            if (isset($vendorId['min'])) {
                $this->addUsingAlias(ProductTableMap::COL_VENDOR_ID, $vendorId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($vendorId['max'])) {
                $this->addUsingAlias(ProductTableMap::COL_VENDOR_ID, $vendorId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProductTableMap::COL_VENDOR_ID, $vendorId, $comparison);
    }

    /**
     * Filter the query on the measure_id column
     *
     * Example usage:
     * <code>
     * $query->filterByMeasureId(1234); // WHERE measure_id = 1234
     * $query->filterByMeasureId(array(12, 34)); // WHERE measure_id IN (12, 34)
     * $query->filterByMeasureId(array('min' => 12)); // WHERE measure_id > 12
     * </code>
     *
     * @see       filterByMeasure()
     *
     * @param     mixed $measureId The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildProductQuery The current query, for fluid interface
     */
    public function filterByMeasureId($measureId = null, $comparison = null)
    {
        if (is_array($measureId)) {
            $useMinMax = false;
            if (isset($measureId['min'])) {
                $this->addUsingAlias(ProductTableMap::COL_MEASURE_ID, $measureId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($measureId['max'])) {
                $this->addUsingAlias(ProductTableMap::COL_MEASURE_ID, $measureId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProductTableMap::COL_MEASURE_ID, $measureId, $comparison);
    }
    ...
    public function filterByVendor($vendor, $comparison = null)
    {
        if ($vendor instanceof \ANSR\Propel\Entity\Vendor) {
            return $this
                ->addUsingAlias(ProductTableMap::COL_VENDOR_ID, $vendor->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ProductTableMap::COL_VENDOR_ID, $vendor->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    /**
     * Filter the query by a related \ANSR\Propel\Entity\Measure object
     *
     * @param \ANSR\Propel\Entity\Measure|ObjectCollection $measure The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildProductQuery The current query, for fluid interface
     */
    public function filterByMeasure($measure, $comparison = null)
    {
        if ($measure instanceof \ANSR\Propel\Entity\Measure) {
            return $this
                ->addUsingAlias(ProductTableMap::COL_MEASURE_ID, $measure->getId(), $comparison);
        } elseif ($measure instanceof ObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }

            return $this
                ->addUsingAlias(ProductTableMap::COL_MEASURE_ID, $measure->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByMeasure() only accepts arguments of type \ANSR\Propel\Entity\Measure or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the Measure relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildProductQuery The current query, for fluid interface
     */
    public function joinMeasure($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('Measure');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'Measure');
        }
    ...
    /**
     * Use the Measure relation Measure object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ANSR\Propel\Entity\MeasureQuery A secondary query class using the current class as primary query
     */
    public function useMeasureQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinMeasure($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Measure', '\ANSR\Propel\Entity\MeasureQuery');
    }
    ...
    public function filterBySale($sale, $comparison = null)
    {
        if ($sale instanceof \ANSR\Propel\Entity\Sale) {
            return $this
                ->addUsingAlias(ProductTableMap::COL_ID, $sale->getProductId(), $comparison);
