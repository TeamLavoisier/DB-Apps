...
/**
 * Base class that represents a row from the 'supermarkets' table.
 *
 *
 *
* @package    propel.generator.ANSR.Propel.Entity.Base
*/
abstract class Supermarket implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ANSR\\Propel\\Entity\\Map\\SupermarketTableMap';
    ...
    /**
     * Initializes internal state of ANSR\Propel\Entity\Base\Supermarket object.
     */
    ...
    /**
     * Compares this with another <code>Supermarket</code> instance.  If
     * <code>obj</code> is an instance of <code>Supermarket</code>, delegates to
     * <code>equals(Supermarket)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Supermarket The current object, for fluid interface
     */
     ...
     * @return $this|\ANSR\Propel\Entity\Supermarket The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SupermarketTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[SupermarketTableMap::COL_NAME] = true;
        }
    ...
    public function setTownId($v)
    {
        ...
        if ($this->town_id !== $v) {
            $this->town_id = $v;
            $this->modifiedColumns[SupermarketTableMap::COL_TOWN_ID] = true;
        }

        if ($this->aTown !== null && $this->aTown->getId() !== $v) {
            $this->aTown = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SupermarketTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SupermarketTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SupermarketTableMap::translateFieldName('TownId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SupermarketTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ANSR\\Propel\\Entity\\Supermarket'), 0, $e);
        }
    }
    ...
    {
        if ($this->aTown !== null && $this->town_id !== $this->aTown->getId()) {
            $this->aTown = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSupermarketQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Supermarket::setDeleted()
     * @see Supermarket::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSupermarketQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SupermarketTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aTown !== null) {
                if ($this->aTown->isModified() || $this->aTown->isNew()) {
                    $affectedRows += $this->aTown->save($con);
                }
                $this->setTown($this->aTown);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[SupermarketTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SupermarketTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SupermarketTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(SupermarketTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(SupermarketTableMap::COL_TOWN_ID)) {
            $modifiedColumns[':p' . $index++]  = 'town_id';
        }

        $sql = sprintf(
            'INSERT INTO supermarkets (%s) VALUES (%s)',
    ...
    {
        $pos = SupermarketTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Supermarket'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Supermarket'][$this->hashCode()] = true;
        $keys = SupermarketTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aTown) {
                ...
                $result[$key] = $this->aTown->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ANSR\Propel\Entity\Supermarket
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ANSR\Propel\Entity\Supermarket The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(SupermarketTableMap::DATABASE_NAME);

        if ($this->isColumnModified(SupermarketTableMap::COL_ID)) {
            $criteria->add(SupermarketTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SupermarketTableMap::COL_NAME)) {
            $criteria->add(SupermarketTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(SupermarketTableMap::COL_TOWN_ID)) {
            $criteria->add(SupermarketTableMap::COL_TOWN_ID, $this->town_id);
        }
    ...
    {
        $criteria = ChildSupermarketQuery::create();
        $criteria->add(SupermarketTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ANSR\Propel\Entity\Supermarket (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ANSR\Propel\Entity\Supermarket Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildTown object.
     *
     * @param  ChildTown $v
     * @return $this|\ANSR\Propel\Entity\Supermarket The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTown(ChildTown $v = null)
    {
        if ($v === null) {
            $this->setTownId(NULL);
        } else {
        ...
        // If this object has already been added to the ChildTown object, it will not be re-added.
        if ($v !== null) {
            $v->addSupermarket($this);
        }
    ...
    /**
     * Get the associated ChildTown object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildTown The associated ChildTown object.
     * @throws PropelException
     */
    public function getTown(ConnectionInterface $con = null)
    {
        if ($this->aTown === null && ($this->town_id !== null)) {
            $this->aTown = ChildTownQuery::create()->findPk($this->town_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTown->addSupermarkets($this);
             */
        }
     ...
     * If this ChildSupermarket is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSupermarket The current object (for fluent API support)
     */
    public function setSales(Collection $sales, ConnectionInterface $con = null)
    {
        ...
        foreach ($salesToDelete as $saleRemoved) {
            $saleRemoved->setSupermarket(null);
        }
     ...
     * Otherwise if this Supermarket is new, it will return
     * an empty collection; or if this Supermarket has previously
     * been saved, it will retrieve related Sales from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Supermarket.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aTown) {
            $this->aTown->removeSupermarket($this);
        }
        $this->id = null;
        $this->name = null;
        $this->town_id = null;
    ...
    {
        return (string) $this->exportTo(SupermarketTableMap::DEFAULT_STRING_FORMAT);
    }
