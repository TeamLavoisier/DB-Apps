...
/**
 * Base class that represents a row from the 'measures' table.
 *
 *
 *
* @package    propel.generator.ANSR.Propel.Entity.Base
*/
abstract class Measure implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ANSR\\Propel\\Entity\\Map\\MeasureTableMap';
    ...
    /**
     * Initializes internal state of ANSR\Propel\Entity\Base\Measure object.
     */
    ...
    /**
     * Compares this with another <code>Measure</code> instance.  If
     * <code>obj</code> is an instance of <code>Measure</code>, delegates to
     * <code>equals(Measure)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Measure The current object, for fluid interface
     */
     ...
     * @return $this|\ANSR\Propel\Entity\Measure The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MeasureTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[MeasureTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MeasureTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MeasureTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = MeasureTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ANSR\\Propel\\Entity\\Measure'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMeasureQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Measure::setDeleted()
     * @see Measure::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMeasureQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MeasureTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[MeasureTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . MeasureTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(MeasureTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(MeasureTableMap::COL_NAME)) {
    ...
    {
        $pos = MeasureTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Measure'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Measure'][$this->hashCode()] = true;
        $keys = MeasureTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ANSR\Propel\Entity\Measure
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ANSR\Propel\Entity\Measure The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(MeasureTableMap::DATABASE_NAME);

        if ($this->isColumnModified(MeasureTableMap::COL_ID)) {
            $criteria->add(MeasureTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MeasureTableMap::COL_NAME)) {
            $criteria->add(MeasureTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildMeasureQuery::create();
        $criteria->add(MeasureTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ANSR\Propel\Entity\Measure (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ANSR\Propel\Entity\Measure Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildMeasure is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMeasure The current object (for fluent API support)
     */
    public function setProducts(Collection $products, ConnectionInterface $con = null)
    {
        ...
        foreach ($productsToDelete as $productRemoved) {
            $productRemoved->setMeasure(null);
        }
     ...
     * Otherwise if this Measure is new, it will return
     * an empty collection; or if this Measure has previously
     * been saved, it will retrieve related Products from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Measure.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildProduct[] List of ChildProduct objects
     */
    public function getProductsJoinVendor(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProductQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(MeasureTableMap::DEFAULT_STRING_FORMAT);
    }
